export const CHAT_AGENT_MODES = ['ask', 'agent', 'add', 'recommend'] as const

export type ChatAgentMode = (typeof CHAT_AGENT_MODES)[number]

export type ModeSwitchReasonKey = 'add_intent' | 'ask_intent' | 'recommend_intent' | 'agent_intent'
...
export function nextChatMode(mode: ChatAgentMode): ChatAgentMode {
