...
function buildBaseInstructions(request: AnalyzePreferencesRequest): string[] {
  ...
  return [
    ...
    'For op=add: ALWAYS set season — comma-separated applicable seasons from: spring, summer, autumn, winter. E.g. "summer" for fresh aquatics, "autumn,winter" for heavy orientals, "spring,summer" for florals.',
